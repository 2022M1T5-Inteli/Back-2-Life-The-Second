...
#Diálogo cena do hospital
	if dialog_index <= 3 and scene == "cena_hospital_portal": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
...
#Diálogo cena do quarto 
	if dialog_index > 3 and dialog_index <= 6 and scene == "cena_quarto": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Diálogo da cena da escola
	elif dialog_index > 6 and dialog_index <= 9 and scene == "cena_escola": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Diálogo da cena da festa
	elif dialog_index > 9 and dialog_index <= 14 and scene == "cena_festa": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Diálogo da cena da faculdade
	elif dialog_index > 14 and dialog_index <= 18 and scene == "cena_faculdade": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Diálogo da cena do posto
	elif dialog_index > 18 and dialog_index <= 21 and scene == "cena_posto": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Diálogo da cena do trabalho
	elif dialog_index > 21 and dialog_index <= 32 and scene == "trabalho": #Condição que confere se o valor do contador não passou do valor de quantidade de arrays
		#Passa o valor da array para o RichTextLabel
		$RichTextLabel.bbcode_text = dialog[dialog_index]
...
#Sinaliza que o diálogo finalizous
