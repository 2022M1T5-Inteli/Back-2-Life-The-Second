...
var dialog = [
	"Estou me sentindo tonto. Vou dar uma olhada no espelho para ver o que está acontecendo... ",
	"Lembro de quando eu era criança, morria de medo de espelhos",
	"Achava que veria algum monstro atrás de mim. ",
	"Calma aí, o que é aquilo dentro do meu espelho???",
	"Meu deus, é o meu quarto de quando eu era mais novo??",
	"Por que eu estou vendo isso? Será que estou alucinando??",
